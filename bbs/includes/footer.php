...
template_hook("footer.template.php", "start");	
	...
	// style switcher
		...
		$lang['footer_copyright']	=	str_replace("<%1>",$nova_version, $lang['footer_copyright']);
		$lang['footer_copyright']	=	str_replace("<%nburl>","<a class=\"copyright\" href=\"http://www.novaboard.net\">", $lang['footer_copyright']);
		$lang['footer_copyright']	=	str_replace("<%nburl2>","</a>", $lang['footer_copyright']);
		$lang['footer_board']		=	str_replace("<%1>","<a class=\"board\" href=\"$nova_domain\">$site_name</a>", $lang['footer_board']);
