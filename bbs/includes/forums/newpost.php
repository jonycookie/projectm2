...
if ($can_add_topics=='0'){
	...
	nova_redirect("index.php?page=error&error=9","error/9");
...
// Email people that have subscribed...
	...
	$lang['email_newpost_content'] = str_replace("<%site>", $nova_domain, $lang['email_newpost_content']);
...
include "scripts/php/auto_cache.php";		
	...
	nova_redirect("index.php?topic=$redirect_topic","topic/$topic_title-$redirect_topic");
...
if ($_GET['forum']==''){
	...
	nova_redirect("index.php?page=error&error=36","error/36");
