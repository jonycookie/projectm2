...
$query212 = "select ID from {$db_prefix}members WHERE verified!='1' ORDER BY ID desc" ;
$result212 = mysql_query($query212) or die("cache.php - Error in query: $query212") ;                                  
while ($results212 = mysql_fetch_array($result212)){
$member_id = strip_slashes($results212['ID']);
...
mysql_query("DELETE FROM {$db_prefix}members WHERE id = '$member_id'");
...
$query212 = "select TOPIC_ID from {$db_prefix}messages WHERE hidden='1' AND hidden_from='1' AND TITLE!='' ORDER BY TOPIC_ID desc" ;
$result212 = mysql_query($query212) or die("cache.php - Error in query: $query212") ;                                  
while ($results212 = mysql_fetch_array($result212)){
$topic_id = strip_slashes($results212['TOPIC_ID']);

// Now remove that message

mysql_query("DELETE FROM {$db_prefix}messages WHERE topic_id = '$topic_id'");
