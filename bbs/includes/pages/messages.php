...
$query2167 = "select NAME from {$db_prefix}members WHERE ID='$member_to'" ;
...
$query1 = "select NAME, EMAIL from {$db_prefix}members WHERE ID='$member_to'" ;
$result1 = mysql_query($query1) or die("subscriptions.php - Error in query: $query1") ; 
$subscriber_name = mysql_result($result1, 0);

$query1 = "select NAME from {$db_prefix}members WHERE ID='$my_id'" ;
$result1 = mysql_query($query1) or die("subscriptions.php - Error in query: $query1") ; 
$subscriber_from = mysql_result($result1, 0);

$query1 = "select EMAIL from {$db_prefix}members WHERE ID='$member_to'" ;
$result1 = mysql_query($query1) or die("subscriptions.php - Error in query: $query1") ; 
$subscriber_email = mysql_result($result1, 0);
