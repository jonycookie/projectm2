...
$query211 = "select NATIONALITY, LOCATION, MSN, AOL, YAHOO, SKYPE, XBOX, WII, PS3, ALLOW_ADMIN_EMAIL from {$db_prefix}members WHERE NAME='$name'" ;
...
mysql_query("UPDATE {$db_prefix}members SET location='$location', nationality='$nationality', msn='$msn', aol='$aol', yahoo='$yim', skype='$skype', xbox='$xbox', wii='$wii', ps3='$ps3', allow_admin_email='$allow_admin_email' WHERE id = '$my_id'");

}

else{

mysql_query("UPDATE {$db_prefix}members SET location='$location', nationality='$nationality', msn='$msn', aol='$aol', yahoo='$yim', skype='$skype', allow_admin_email='$allow_admin_email' WHERE id = '$my_id'");
