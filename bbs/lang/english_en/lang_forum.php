...
$lang = array (
	...
	// This block deals with the header, footer and navigation bar
		...
		//footer
			...
			'footer_copyright'     			=> "Powered by <%nburl>NovaBoard v<%1><%nburl2>",
	...
	// This block deals with the pages folder within NovaBoard.
	// Primarily, this is search, messages, error pages etc.
		...
		// admin
			...
			'admin_link_modules'			=> "Modules Settings",
			'admin_link_themes'				=> "Themes Settings",			
			...
			'admin_link_emoticons'			=> "Emoticon Settings",
		...
		// members
			...
			'members_yahoo'					=> "Yahoo",
			'members_skype'					=> "Skype",
			'members_xbox'					=> "Xbox, Xbox360",
			'members_ps3'					=> "Playstation 3",
		...
		// myoptions	
			...
			'myoptions_signature'			=> "Signature Setting",
...
6. You agree that if you break any of these terms and/or any additional terms the administrators set for their forum that your account may be suspended without warning and you may lose all rights to post on this forum.",
	...
	// means, please visit http://uk3.php.net/strftime
		...
		// date
			'date_format'					=> "%A, %b %d, %Y %R",  // Weekday, nn Month, Year HH:MM
			'date_today'					=> "Today",
