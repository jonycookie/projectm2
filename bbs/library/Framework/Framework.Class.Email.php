...
class Email {
	...
	function Clear() {
		...
		$this->Body = "";
		$this->FatalError = 1;
		$this->MimeType = ForceString(
			@$this->Context->Configuration['DEFAULT_EMAIL_MIME_TYPE'], 'text/plain');
	}
		...
		if ($this->ValidateEmail()) {
			...
			// Build the headers
				...
				$Header .= 'Date: '.date('r')
					...
					.'; charset='.$this->Context->Configuration['CHARSET']
					."\r\n"
