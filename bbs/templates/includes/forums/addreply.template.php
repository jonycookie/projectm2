...
<?php if ($allow_attachments=='0'){} elseif ($can_add_attachment=='1'){ ?>
							...
							<table class="forum-jump" cellpadding="0" cellspacing="0">
								<tr><td class="forum-jump-content full-border">
									...
									<div id="file">
										<object name="uploadframe" data="<?php echo "$nova_domain"; ?>/uploads/upload.php?topicid=<?php echo "$topic"; ?>&attachtype=attachments&member=<?php echo "$uploader_id"; ?>&hash=<?php echo "$hash"; ?>" type="text/html" class="attachment-jump"></object>
									</div>
								</td></tr>
							</table>
							<div class="spacer">&nbsp;</div>
