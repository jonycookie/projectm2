...
<?php }elseif ($template_hook=='1'){ ?>
		...
		<table class="forum-board-forum-head" cellspacing="0" cellpadding="0">
			<tr>
				<td class="forum-topic-subject"><a class="forum-header" href="<?php echo nova_link("index.php?forum=$parent_id", "forum/$forum_title-$parent_id"); ?>"><?php echo "$parent_name"; ?></a></td>
...
<?php }} elseif ($template_hook=='6'){ ?>
				...
				<!-- post information -->
				<td class="forum-index-td-right<?php echo "$alt_td_class"; ?>"><?php echo "$time"; ?><br />
<?php if ($can_read_topics=='0'){ ?>
					<?php echo $lang['board_topic_in']; ?> <?php echo $lang['board_topic_restricted']; ?><br />
<?php } else{ ?>
					<?php echo $lang['board_topic_in']; ?> <a class="forum-index-link-to-topic" href="<?php echo nova_link("index.php?page=findpost&post=$id", "findpost/$id"); ?>"><?php echo "$title"; ?></a><br />
<?php } ?>
...
<?php if ($_COOKIE['nova_name']!=''){ ?>
	<!-- mark all topics read -->
		<table class="forum-board-forum-head" cellpadding="0" cellspacing="0">
			<tr>
				<td class="forum-index-stats-sub">
					<a class="forum-header mark-read" href="<?php echo nova_link("index.php?func=markread", "markread"); ?>"><?php echo $lang['index_markread']; ?></a>
				</td>
			</tr>
		</table>
<?php } ?>
