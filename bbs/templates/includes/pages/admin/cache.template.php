...
<?php }elseif ($template_hook=='10'){ ?>
			...
			<tr><td class="forum-jump-content forum-index-top forum-index-bottom">
				<a href="<?php echo nova_link("index.php?page=admin&act=cache&func=posts","admin/cache/posts"); ?>"><strong><?php echo $lang_admin['cache_posts_cache']; ?></strong></a>
			...
			<tr><td class="forum-jump-content forum-index-top forum-index-bottom">
				<a href="<?php echo nova_link("index.php?page=admin&act=cache&func=verify","admin/cache/verify"); ?>"><strong><?php echo $lang_admin['cache_members_remove']; ?></strong></a>
			...
			<tr><td class="forum-jump-content forum-index-top forum-index-bottom">
				<a href="<?php echo nova_link("index.php?page=admin&act=cache&func=messages","admin/cache/messages"); ?>"><strong><?php echo $lang_admin['cache_messages_remove']; ?></strong></a>
			...
			<tr><td class="forum-jump-content forum-index-top forum-index-bottom">
				<a href="<?php echo nova_link("index.php?page=admin&act=cache&func=readall","admin/cache/readall"); ?>"><strong><?php echo $lang_admin['cache_read_posts_title']; ?></strong></a>
			...
			<tr><td class="forum-jump-content forum-index-top forum-index-bottom">
				<a href="<?php echo nova_link("index.php?page=admin&act=cache&func=online","admin/cache/online"); ?>"><strong><?php echo $lang_admin['cache_members_online_title']; ?></strong></a>
			...
			<tr><td class="forum-jump-content forum-index-top forum-index-bottom">
				...
				<form method="post" action="<?php echo nova_link("index.php?page=admin&act=cache&func=forums","admin/cache/forums"); ?>">
