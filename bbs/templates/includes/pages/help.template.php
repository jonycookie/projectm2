		...
		<table class="forum-index" cellpadding="0" cellspacing="0">
			...
			<tr>
				<td class="forum-jump-content" style="width:100%;">
					<a href="<?php echo nova_link("index.php?page=help&h=2", "help/2"); ?>"><strong><?php echo $lang_help['help_search_title']; ?></strong></a><br />
					<?php echo $lang_help['help_search_desc']; ?><br /><br />
					<a href="<?php echo nova_link("index.php?page=help&h=3", "help/3"); ?>"><strong><?php echo $lang_help['help_active_title']; ?></strong></a><br />
					<?php echo $lang_help['help_active_desc']; ?><br /><br />
					<a href="<?php echo nova_link("index.php?page=help&h=4", "help/4"); ?>"><strong><?php echo $lang_help['help_email_title']; ?></strong></a><br />
					<?php echo $lang_help['help_email_desc']; ?><br /><br />
					<a href="<?php echo nova_link("index.php?page=help&h=5", "help/5"); ?>"><strong><?php echo $lang_help['help_myoptions_title']; ?></strong></a><br />
					<?php echo $lang_help['help_myoptions_desc']; ?><br /><br />
					<a href="<?php echo nova_link("index.php?page=help&h=6", "help/6"); ?>"><strong><?php echo $lang_help['help_messages_title']; ?></strong></a><br />
					<?php echo $lang_help['help_messages_desc']; ?><br /><br />
					<a href="<?php echo nova_link("index.php?page=help&h=7", "help/7"); ?>"><strong><?php echo $lang_help['help_register_title']; ?></strong></a><br />
					<?php echo $lang_help['help_register_desc']; ?><br /><br />
					<a href="<?php echo nova_link("index.php?page=help&h=8", "help/8"); ?>"><strong><?php echo $lang_help['help_password_title']; ?></strong></a><br />
					<?php echo $lang_help['help_password_desc']; ?><br /><br />
					<a href="<?php echo nova_link("index.php?page=help&h=9", "help/9"); ?>"><strong><?php echo $lang_help['help_members_title']; ?></strong></a><br />
					<?php echo $lang_help['help_members_desc']; ?><br /><br />
					<a href="<?php echo nova_link("index.php?page=help&h=10", "help/10"); ?>"><strong><?php echo $lang_help['help_login_title']; ?></strong></a><br />
					<?php echo $lang_help['help_login_desc']; ?><br /><br />
					<a href="<?php echo nova_link("index.php?page=help&h=11", "help/11"); ?>"><strong><?php echo $lang_help['help_posting_title']; ?></strong></a><br />
					<?php echo $lang_help['help_posting_desc']; ?><br /><br />	
					<a href="<?php echo nova_link("index.php?page=help&h=12", "help/12"); ?>"><strong><?php echo $lang_help['help_mods_title']; ?></strong></a><br />
