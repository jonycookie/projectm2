...
<?php }elseif ($template_hook=='3'){ ?>
		...
		<div class="new-topic-placer">
			<a class="submit-button-large img-add-forum" href="<?php echo nova_link("index.php?page=messages&act=new", "messages/new"); ?>" /><?php echo $lang['button_new_message']; ?></a>
		</div>
...
<?php } ?>
				...
				<td class="forum-index-td-middle<?php echo "$alt_td_class"; ?>" style="vertical-align: middle; style="padding: 5px;"">
					<a class="topic-link-board"  href="<?php echo nova_link("index.php?page=messages&id=$topic_id", "messages/$topic_id"); ?>"><?php echo "$title"; ?></a>
				</td>
...
<?php } ?>
				...
				<td class="forum-index-td-posts<?php echo "$alt_td_class"; ?>" style="width: 50%; text-align: left; padding: 5px;">
					...
					<br />
					<a class="forum-index-link-to-topic"  href="<?php echo nova_link("index.php?page=messages&id=$topic_id#last", "messages/$topic_id#last"); ?>"><?php echo $lang['messages_last_by']; ?></a> 
...
<?php } ?>
				...
				<td class="forum-index-td-right<?php echo "$alt_td_class"; ?>" style="padding: 5px;">
					<a href="<?php echo nova_link("index.php?page=messages&act=del&id=$topic_id", "messages/del/$topic_id"); ?>" onclick="javascript:return confirm('<?php echo $lang['topic_remove']; ?>')"><img  src="<?php echo "$delete_icon_img"; ?>" alt="<?php echo $lang['topic_option_delete']; ?>" title="<?php echo $lang['topic_option_delete']; ?>"  /></a>
				</td>
			</tr>
...
<?php }elseif($template_hook=='7'){ ?>
		...
		<table class="forum-jump" cellpadding="0" cellspacing="0">
			<tr><td class="forum-jump-content" style="width:100%;">	
				<form name="postcontent" method="post" class="asholder" action="<?php echo nova_link("index.php?page=messages&act=new", "messages/new"); ?>">
					<table class="forum-jump" cellpadding="0" cellspacing="0">
						<tr><td class="forum-jump-content" style="width:100%;">
...
<?php } ?>
					<span class="forum-topic-time">
						...
						<span class="forum-topic-admin"><a href="javascript:void(0);" onclick="toggletrmessage(<?php echo $post_id; ?>)" id="trmessagetogglebutton_<?php echo $post_id; ?>"><?php echo(($TAG_message_status == 0) ? '+' : '-'); ?></a></span>
					</span>		 
				</td>
			</tr>
			...
			<table class="forum-jump" cellpadding="0" cellspacing="0">
				<tr>
					<td class="forum-jump-content" style="width:100%;">		
						...
						<div class="textarea-addreply">
							<form name="postcontent" method="post" action="<?php echo nova_link("index.php?page=messages&act=reply", "messages/reply"); ?>">
...
<?php } ?>
		<script type="text/javascript">
			var options = {
				script:"<?php echo "$nova_domain"; ?>/scripts/php/autosuggest.php?json=true&limit=6&member=<?php echo "$my_id"; ?>&",
				varname:"input",
				json:true,
				shownoresults:true,
				maxresults:1000,
			...
			var options_xml = {
				script: function (input) { return "<?php echo "$nova_domain"; ?>/scripts/php/autosuggest.php?input="+input+"&member_to="+document.getElementById('member_to').value; },
				varname:"input"
			};
