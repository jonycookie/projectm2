...
<?php }elseif ($template_hook=='1'){ ?>
		...
		<table class="forum-index" cellpadding="0" cellspacing="0">
			...
			<tr><td class="forum-jump-content forum-index-top forum-index-bottom"><br /><br />
				<form name="register" action="<?php echo nova_link("index.php?page=register", "register"); ?>" onsubmit="return validate_info(); return check_passwords" method="post">
...
<?php }elseif ($template_hook=='captcha'){ ?>
					<div style="width: 100%; float: left; text-align: center;">
						...
						<br />
						<img src="<?php echo "$nova_domain"; ?>/scripts/php/captcha/CaptchaSecurityImages.php?width=140&height=40&characters=8" alt="captcha" />
						<br />
...
<?php }elseif ($template_hook=='4'){ ?>
		...
		<table class="forum-index" cellpadding="0" cellspacing="0">
			...
			<tr><td class="forum-jump-content" style="border-top: none; border-bottom: none;">
				<form action="<?php echo nova_link("index.php?page=register", "register"); ?>" onsubmit="return check_agreement('<?php echo $lang['register_terms_conditions_warn'] ?>')" method="post">
