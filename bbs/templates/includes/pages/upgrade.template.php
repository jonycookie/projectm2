...
<?php } ?>
							...
							<input type="hidden" name="return" value="<?php echo "$nova_domain"; ?>/index.php?page=upgrade&status=return">
							<input type="hidden" name="notify_url" value="<?php echo "$nova_domain"; ?>/index.php?page=upgrade&status=paid&member=<?php echo "$my_id"; ?>">
							<input type="hidden" name="cancel_return" value="<?php echo "$nova_domain"; ?>/index.php?page=upgrade&status=cancel">
