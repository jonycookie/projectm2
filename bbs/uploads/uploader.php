...
$nova_domain 	= str_replace('/uploads/uploader.php', '', $my_address); 	// returns http://myforum.com/forum style address
...
// MESSAGE IN HERE!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
	...
	header("Location: $nova_domain/uploads/upload.php?topicid=$topicid&attachtype=$attachtype&member=$my_id&hash=$hash");
	exit;
