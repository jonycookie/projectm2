...
/*
	...
	$Id: cp_upload.php 12545 2009-07-07 07:43:29Z liguode $
*/
...
if(submitcheck('albumsubmit')) {
	...
	if($eventid){//跳到活动页面
		...
		$_SGLOBAL['db']->query("UPDATE ".tname("event")." SET picnum=(SELECT COUNT(*) FROM ".tname("eventpic")." WHERE eventid='$eventid'), updatetime='$_SGLOBAL[timestamp]' WHERE eventid='$eventid'");
