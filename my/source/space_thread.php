...
/*
	...
	$Id: space_thread.php 12998 2009-08-05 03:29:54Z liguode $
*/
...
if($id) {
	...
	//热闹
	if(!$topic = topic_get($thread['topicid'])) {
		updatetable('thread', array('topicid'=>0), array('topicid'=>$blog['topicid']));
	}
	...
	if(!in_array($_GET['view'], array('hot','new','me'))) {
		$_GET['view'] = 'hot';
	}
