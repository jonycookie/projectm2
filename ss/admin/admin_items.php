...
/*
	...
	$Id: admin_items.php 13368 2009-09-23 06:53:35Z zhaofei $
*/
...
if(empty($listarr) && empty($itemidarr)) {
	...
	<tr>
	<th>$alang[information_types]</th>
	<td><select name="type">
		<option value="news">$alang[common_type_news]</option>
		</select></td>
	</tr>
	<tr>
	<th>$alang[information_state]</th>
	<td><select name="folder">
		<option value="">$alang[block_thread_blog_0]</option>
	...
	<table cellspacing="0" cellpadding="0" width="100%"  class="maintable">
	<tr>
	<th>$alang[information_types]$alang[information_types_notes]</th>
	<td><select name="type">
		<option value="news">$alang[common_type_news]</option>
		</select></td>
	</tr>
