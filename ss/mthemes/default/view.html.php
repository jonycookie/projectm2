...
<div class="column">
	<div class="col1">
		...
		<div class="global_module margin_bot10 bg_fff">
			...
			<!--{if !empty($modelsinfoarr[allowcomment]) && !empty($item[allowreply]) &&!empty($_SCONFIG['commstatus'])}-->
			...
			<div id="comment_op"><a href="#action/viewcomment/itemid/$item[itemid]/type/$modelsinfoarr[modelname]#" class="view" target="_blank">查看全部回复</a><span>【已有$news[replynum]位网友发表了看法】</span></div>
