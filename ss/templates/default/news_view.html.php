		...
		<div class="global_module margin_bot10 bg_fff">
			...
			<div id="article">
				...
				<div id="article_extinfo">
					...
					<div><span>热度{$news[hot]}票&nbsp;&nbsp;浏览{$news[viewnum]}次<!--{if !empty($_SCONFIG['commstatus'])}--> 【<a class="color_red" href="#action/viewcomment/itemid/$news[itemid]#" target="_blank" title="点击查看">共$news[replynum]条评论</a>】【<a class="color_red" href="#sign_msg">我要评论</a>】<!--{/if}--></span>
