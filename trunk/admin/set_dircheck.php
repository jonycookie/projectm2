...
$htm_check = is_writeable(D_P.$very['htmdir']) ? $yes : $no;
$img_check = is_writeable(D_P.$very['attachdir']) ? $yes : $no;
$imgtemp_check = is_writeable(D_P.$very['attachdir'].'/temp') ? $yes : $no;
$imgs_check = is_writeable(D_P.$very['attachdir'].'/s') ? $yes : $no;
...
$jscache_check = is_writeable(D_P.'script/verycms') ? $yes : $no;
