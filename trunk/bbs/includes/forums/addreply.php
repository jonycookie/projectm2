...
if ($can_reply_topics=='0'){
	...
	nova_redirect("index.php?page=error&error=1","error/1");
...
$lang['email_addreply_content'] = str_replace("<%site>", $nova_domain, $lang['email_addreply_content']);
...
include "scripts/php/auto_cache.php";
	...
	nova_redirect("index.php?page=findpost&post=$post_id","findpost/$post_id");
...
$quote="&#91;quote name=$member_name trackback=$quote&#93;
$quote_content
&#91;/quote&#93;";
...
$quote_temp="&#91;quote name=$member_name trackback=$id&#93;
$quote_content
&#91;/quote&#93;";
