...
$most_online_date = $results9['MOST_ONLINE_DATE'];

$time = format_date($most_online_date); 

}

$lang['online_stats_most'] = str_replace("<%1>","$most_online",$lang['online_stats_most']);
$lang['online_stats_most'] = str_replace("<%date>","$time",$lang['online_stats_most']);
