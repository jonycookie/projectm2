...
$can_view_board				= escape_string($_POST['can_view_board']);
$can_warn_members	 		= escape_string($_POST['can_warn_members']); 
$can_edit_members	 		= escape_string($_POST['can_edit_members']);
$can_delete_members	 		= escape_string($_POST['can_delete_members']);
$can_ban_members	 		= escape_string($_POST['can_ban_members']);
$can_change_site_settings	= escape_string($_POST['can_change_site_settings']);
$can_change_forum_settings	= escape_string($_POST['can_change_forum_settings']);
$can_change_style			= escape_string($_POST['can_change_style']);
$can_use_avatar				= escape_string($_POST['can_use_avatar']);
$can_change_user_title		= escape_string($_POST['can_change_user_title']);
$can_use_sig				= escape_string($_POST['can_use_sig']);
$can_change_own_name		= escape_string($_POST['can_change_own_name']);
$can_pm						= escape_string($_POST['can_pm']);
$can_edit_own_posts			= escape_string($_POST['can_edit_own_posts']);
$can_edit_others_posts		= escape_string($_POST['can_edit_others_posts']);
$can_delete_own_posts		= escape_string($_POST['can_delete_own_posts']);
$can_delete_others_posts	= escape_string($_POST['can_delete_others_posts']);
$can_sticky_topics			= escape_string($_POST['can_sticky_topics']);
$can_global_announce		= escape_string($_POST['can_global_announce']);
$can_move_topics			= escape_string($_POST['can_move_topics']);
$can_lock_topics			= escape_string($_POST['can_lock_topics']);
$can_split_topics			= escape_string($_POST['can_split_topics']);
$can_merge_topics			= escape_string($_POST['can_merge_topics']);
$can_add_polls				= escape_string($_POST['can_add_polls']);
$can_see_reported_posts		= escape_string($_POST['can_see_reported_posts']);
$can_use_html				= escape_string($_POST['can_use_html']);
$can_moderate_members		= escape_string($_POST['can_moderate_members']);
$avoid_caspian				= escape_string($_POST['avoid_caspian']);
...
mysql_query("INSERT INTO {$db_prefix}permissions (group_id, forum_id, can_view_forum, can_read_topics, can_add_topics, can_reply_topics, can_add_attachment, can_download_attachment) VALUES ('$group_copy_id', '$forum_copy_id', '$can_view_forum_copy', '$can_read_topics_copy', '$can_add_topics_copy', '$can_reply_topics_copy', '$can_add_attachment_copy', '$can_download_attachment_copy')");
	...
	nova_redirect("index.php?page=admin&act=groups","admin/groups");
...
$groupid = escape_string($_POST['group_id']);
...
$group_copy_id = escape_string($_POST['group_copy_id']);
