...
$forum_id=escape_string($_POST['forum']);
$member_id=escape_string($_POST['id']);

$mod_can_warn_members=$_POST['mod_can_warn_members'];
$mod_can_warn_members=escape_string($mod_can_warn_members);

$mod_can_ban_members=$_POST['mod_can_ban_members'];
$mod_can_ban_members=escape_string($mod_can_ban_members);

$mod_can_edit_own_posts=$_POST['mod_can_edit_own_posts'];
$mod_can_edit_own_posts=escape_string($mod_can_edit_own_posts);

$mod_can_edit_others_posts=$_POST['mod_can_edit_others_posts'];
$mod_can_edit_others_posts=escape_string($mod_can_edit_others_posts);

$mod_can_delete_own_posts=$_POST['mod_can_delete_own_posts'];
$mod_can_delete_own_posts=escape_string($mod_can_delete_own_posts);

$mod_can_delete_others_posts=$_POST['mod_can_delete_others_posts'];
$mod_can_delete_others_posts=escape_string($mod_can_delete_others_posts);

$mod_can_sticky_topics=$_POST['mod_can_sticky_topics'];
$mod_can_sticky_topics=escape_string($mod_can_sticky_topics);

$mod_can_move_topics=$_POST['mod_can_move_topics'];
$mod_can_move_topics=escape_string($mod_can_move_topics);

$mod_can_lock_topics=$_POST['mod_can_lock_topics'];
$mod_can_lock_topics=escape_string($mod_can_lock_topics);

$mod_can_split_topics=$_POST['mod_can_split_topics'];
$mod_can_split_topics=escape_string($mod_can_split_topics);

$mod_can_merge_topics=$_POST['mod_can_merge_topics'];
$mod_can_merge_topics=escape_string($mod_can_merge_topics);

$mod_can_add_polls=$_POST['mod_can_add_polls'];
$mod_can_add_polls=escape_string($mod_can_add_polls);

$mod_can_see_reported_posts=$_POST['mod_can_see_reported_posts'];
$mod_can_see_reported_posts=escape_string($mod_can_see_reported_posts);

$mod_can_use_html=$_POST['mod_can_use_html'];
$mod_can_use_html=escape_string($mod_can_use_html);

$mod_can_moderate_members=$_POST['mod_can_moderate_members'];
$mod_can_moderate_members=escape_string($mod_can_moderate_members);
