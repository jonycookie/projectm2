...
$lang_admin = array (
	...
	// this area deals with the admin control panel
		...
		// attachments
			'attachments_title'				=> "Attachment Settings",
		...
		// cache
			...
			'cache_messages_desc'			=> "When a user deletes a private message it still remains in the database. This is down to the way private messages works on NovaBoard. This option will remove private messages that have been deleted by both the sender and the receiver.",
		...
		// categories
			...
			'categories_forums'				=> "Forum Categories",
		...
		// members
			...
			'members_comm_msn'				=> "MSN",
			'members_comm_aol'				=> "AOL",
			'members_comm_yim'				=> "Yahoo!",
			...
			'members_tags_xbox'				=> "Microsoft XBox/XBox360",
			'members_tags_wii'				=> "Nintendo Wii",
			'members_tags_ps3'				=> "Sony Playstation 3",
			...
			'members_select_title'			=> "Select A Member",
		...
		// moderators
			'moderators_title'				=> "Forum Moderators",
		...
		// modules
			...
			'modules_replacement_top'		=> 'Remote install is currently unavailable.',
			'modules_replacement_desc'		=> 'The remote modules feature is currently disabled until the new NovaBoard mainsite is launched.<br /><br />Until then, you can download modules from our <a href="http://community.novaboard.net/forum/completed-modules-9">community forums</a>.',
		...
		// preview
			...
			'preview_desc'					=> "The following posts require approval before being viewable by other members. Please review the post and select to approve or reject it.",
			'preview_id'					=> "Post ID",
		...
		// settings
			...
			'settings_usertitle_desc'		=> 'Set the maximum number of characters available for members\' usernames.',
			...
			'settings_password_desc'		=> "For added security, members should change their password frequently. Enter the number of days a members password is valid for before being told to change it.",
		...
		// smilies
			...
			'smilies_theme_title'			=> "Emoticon Location",
		...
		// spam
			...
			'spam_desc'						=> "Akismet is the best way to identify posts as spam or not. To use this service, you must register to obtain an API key.<br /><br />
												This key can be obtained by visiting <a href='http://wordpress.com/signup/'>wordpress.com</a> and sign up for a blog. Once registered, visit <a href='http://dashboard.wordpress.com/wp-admin/profile.php'>your wordpress profile page</a> where you will see your API key.<br /><br />
			...
			'spam_recaptcha_desc'			=> "reCAPTCHA is a human verification script that can replace the default CAPTCHA on the boards registration screen. It provides better security than our standard CAPTCHA and so it's use is very much encouraged.<br /><br />
												You will need a valid public & private key for this to work (please do not simply fill in the fields with anything other than valid keys otherwise the registration page will not operate properly). To get your keys, you need to sign up to the <a href='%recaptcha_website%'>reCAPTCHA website</a>",
		...
		// themes
			...
			'themes_replacement_top'		=> 'Remote install is currently unavailable.',
			'themes_replacement_desc'		=> 'The remote themes feature is currently disabled until the new NovaBoard mainsite is launched.<br /><br />Until then, you can download themes from our <a href="http://community.novaboard.net/forum/completed-themes-14">community forums</a>.',
			
		// topics
			'topics_title'					=> "Topics & Posts Settings",
