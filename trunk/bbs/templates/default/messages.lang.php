...
(
	...
	'ajax_thread_rate_range_invalid' => '您未输入分值或超过每次评分范围限制。',
	...
	'post_edit_nopermission' => '对不起，您没有权力编辑他人发表的帖子，请返回。',
	...
	'post_reply_blog_succeed' => '非常感谢，您的评论已经发布，现在将转入文集。',
	'post_reply_mod_succeed' => '非常感谢，管理员设置了需要对新回复进行审核，您的帖子通过审核后将被显示出来，现在将转入主题列表。',
	'post_reply_mod_blog_succeed' => '非常感谢，管理员设置了需要对评论进行审核，您的评论通过审核后将被显示出来，现在将转入文集。',
	...
	'post_newthread_mod_blog_succeed' => '非常感谢，管理员设置了需要对本栏目新文章进行审核，您的文章通过审核后将被显示出来，现在将转入文集。',
	...
	'register_invite_notfound' => '没有填写邀请码不能注册，请返回。',
	'register_invite_error' => '邀请码不正确，请返回。',
	'register_invite_iperror' => '注册用户IP和邀请码拥有者IP相同，不能注册请返回。',
	'register_invite_expiration' => '邀请码已过期，不能使用请返回。',
	...
	'profile_passwd_wrong' => '原密码不正确，您不能修改密码或Email或安全提问，请返回。',
	...
	'profile_alipay_msn' => 'MSN账号无效，请返回重新填写。',
	...
	'credits_policy_num_lowerlimit' => '对不起，您的操作将会导致您的 <b>{$extcredits[$id][title]}</b> 低于系统规定的下限值 {$extcredits[$id][lowerlimit]} {$extcredits[$id][unit]}，请返回修正后重新提交。',
	...
	'reward_end' => '对不起，请确认是否是悬赏贴或者悬赏已经结束。',
	...
	'ajax_pm_newbie_span' => '对不起，您只在注册时间起 $newbiespan 小时后才有发短消息权限。',
	...
	'ajax_pm_send_nonexistence' => '收件人{$msgto}不存在。',
	'pm_send_invalid' => '您的消息没有填写完整，请返回修改。',
	'ajax_pm_send_invalid' => '您的消息没有填写完整。',
	'pm_send_toomany' => '收件人数量超过 $maxpmsend 人，请返回修改。',
	'pm_send_ignore' => '$member[username] 拒绝接受您或所有人发来的短消息，请返回修改。',
	'ajax_pm_send_ignore' => '$member[username] 拒绝接受您或所有人发来的短消息。',
	'pm_send_succeed' => '短消息发送成功，现在将转入消息列表。',
	'ajax_pm_send_succeed' => '短消息发送成功。',
	'pm_saved_succeed' => '短消息已保存，现在将转入草稿箱。',
	'pm_delete_succeed' => '指定消息成功删除。',
	'pm_mark_unread_succeed' => '标记为未读成功。',
	'pm_ignore_succeed' => '忽略列表已成功更新，现在将转入消息列表。',
	'pm_noprompt_succeed' => '短消息已忽略。',
	'ajax_pm_noprompt_succeed' => '',
	...
	'admin_moderate_invalid' => '对不起，您没有选择主题或者无法操作特殊主题，请返回修改。',
	'admin_getip_nopermission' => '对不起，您没有权限查看比您高级的管理员 IP，请返回。',
	'admin_delpost_invalid' => '您没有选择要删除的帖子，请返回。',
	'admin_banpost_invalid' => '您没有选择要屏蔽的帖子，请返回。',
	'admin_move_illegal' => '您选择的目标版块与原版块相同，请返回修改。',
	...
	'admin_merge_invalid' => '对不起，您没有权限合并当前版块以外的主题或将主题与自身合并，请返回。',
	'admin_succeed' => '管理操作成功，现在将返回论坛。',
	'admin_succeed_next' => '管理操作成功，现在将转入后续操作。',
	'admin_move_invalid' => '您没有选择目标版块或者目标版块不存在，请返回修改。',
	'admin_move_have_mod' => '目标版块需要内容审核，您不能将主题复制或者移动到那里。',
	'admin_move_nopermission' => '对不起，你在目标版块没有发帖权限或者发表特殊主题的权限，请返回。',

	'supe_post_reply_succeed' => '非常感谢，您的回复已经发布，现在将转入主题页。',
	'supe_resource_not_exist' => '该资源不存在，或者被删除。请返回。',
	'supe_resource_is_not_of_you' => '该资源不是您所发布，您没有权力操作他人的资源。请返回。',
	'supe_resource_have_imported_into_forum' => '该资源已经导入论坛， 请不要重复导入。请返回。',
	'supe_resource_imported_forbid' => '对不起！论坛没有开启 SupeSite，您不能导入资源，请返回。',
	'supe_imported_succeed' => '你所选择的资源已经成功导入论坛！',
	'supe_pls_select_forum' => '您选择论坛的论坛不存在或者您没有权限导入！请返回修改。',
	'supe_newthread_import_mod_succeed' => '你所选择的资源已经成功导入论坛！<br />管理员设置了需要对新主题进行审核，现在将转入主题列表，您的帖子通过审核后将被显示出来。',
	'supe_imported_newthread_have_replies' => '对不起，管理员设置了需要对该论坛的帖子进行审核，您的资源已经有人回复，不能导入该论坛，请您返回尝试选择其它论坛。',
	'supe_post_edit_succeed' => '您的帖子编辑成功，现在将转入主题页。',
	'supe_post_reply_succeed' => '非常感谢，您的回复已经发布，现在将转入主题页。',
	'supe_post_newthread_succeed' => '非常感谢，您的主题已经发布，现在将转入主题页。',
	'supe_pushsetting_nohand' => '当前论坛设置不允许手工推送到 SupeSite，请返回检查。',
	'supe_pushsetting_noopen' => '论坛没有开启 SupeSite，您不能推送主题，请返回检查。',
	'supe_imported_trade_notallowed' => '对不起！您无法将该商品导入论坛，导致此结果的原因可能是论坛没有开启交易功能，或者管理员没有设置交易帐号，请返回。',
	'supe_imported_trade_forum_notallowed' => '对不起！您没有权限将此商品导入该论坛，导致此结果的原因可能是您所选择的论坛不允许发布商品主题，或者您所在的用户没有权限进行交易，请返回。',
	'supe_pwverify' => '您输入的密码不正确，不能访问这个圈子。',
	'supe_pwpass' => '密码验证成功，现在将转入主题页。',
	'supe_permission_limit' => '对不起，此帖仅对圈内人士开放！',

	'special_noaction' => '特殊主题不允许进行此操作，请返回。',
	...
	'space_style_nofound' => '个人空间风格不存在，请返回。',
	'space_layout_nocenter' => '中间栏至少要有一个模块，请返回。',
	'space_setting_succeed' => '个人空间设置保存成功。<br /><br /><a href=\"memcp.php?action=spacemodule\">[ 需要继续管理个人空间请点击这里 ]</a>',
	...
	'magics_credits_no_enough' => '您的 {$extcredits[$creditstrans][title]} 不足，请返回修改购买道具数量。',
	'magics_num_no_enough' => '库存不足，请返回修改购买道具数量。',
	'magics_amount_no_enough' => '没有足够的道具可以操作，请返回修改。',
	'magics_num_invalid' => '操作数量不合法，请返回修改。',
	'magics_succeed' => '道具操作成功。',
	'magics_post_anonymous' => '匿名贴不允许使用此道具，请返回。',
	'magics_price_iszero' => '您的道具售价扣除积分交易税后为 0，请返回修改。',
	...
	'magics_weight_range_invalid' => '超过最大道具负载量，请返回修改。',
	...
	'magics_MOK_message' => '恭喜您，获得 {$getmoney} {$extcredits[$creditstrans][title]} 请返回',
	'magics_SEK_message' => '此人的IP为: {$post[useip]} 请返回。',
	'magics_RTK_on_message' => '你查询的会员不在线。',
	'magics_RTK_off_message' => '你查询的会员在线，所在位置 {$actioncode[$msession[action]]} 请返回。',
	...
	'circle_nopermission' => '对不起，你尚未加入本圈，无法进行此操作。请返回。',
	...
	'invite_num_invalid' => '购买数量非法',
	'invite_buy_succeed' => '购买成功。',
	'invite_mark_succeed' => '标记操作成功。',
	'invite_num_buy_range_invalid' => '超过您所在用户组邀请码拥有数量的最大值，请返回修改购买数量。',
	'invite_num_range_invalid' => '您所拥有的邀请码数量已经到达最大值，请返回。',
	'invite_credits_no_enough' => '您的 {$extcredits[$creditstrans][title]} 不足，请返回修改购买数量。',
	...
	'debate_poll_thread_succeed' => '投票成功。<script type=\"text/javascript\">\$(\'votes$stand\').innerHTML = parseInt(\$(\'votes$stand\').innerHTML) + 1;</script>',
	'debate_poll_post_succeed' => '投票成功。<script type=\"text/javascript\">\$(\'postvoter_$pid\').innerHTML = parseInt(\$(\'postvoter_$pid\').innerHTML) + 1;</script>',
	...
	'reprint_invalid' => '转贴数据不存在，请返回。',
	'rate_view' => '查看评分记录',
	'thread_rate_succeed' => '转贴数据不存在，请返回。',

	'seccode_player' => '',
	'ajax_seccode_player' => '{$flashcode} <a href=\"###\" onclick=\"updateseccode(1)\"><img border=\"0\" src=\"images/common/seccodeplayer.gif\" /> 播放验证码</a> &nbsp;&nbsp; <a href=\"###\" onclick=\"updateseccode()\">更换验证码</a>',
