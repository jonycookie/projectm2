...
<?php }elseif($template_hook=='2'){ ?>
		...
		<form name="submit" method="post" action="<?php echo nova_link("index.php?func=merge","merge"); ?>">
			<table class="forum-index" cellpadding="0" cellspacing="0">
				...
				<tr><td class="forum-jump-content forum-index-top forum-index-bottom">				
					...
					<div style="width: 70%; float: left;">
						<select name="forum" onchange="location.href='<?php echo nova_link("index.php?func=merge&topic=$topic&forum=","merge/$topic/"); ?>'+escape(this.options[this.selectedIndex].value)">
