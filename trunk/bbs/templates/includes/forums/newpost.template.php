		...
		<table class="forum-jump" cellpadding="0" cellspacing="0">
			<tr>
				<td class="forum-jump-content" style="width:100%;">
					<form id="postcontent" method="post" name="postcontent" action="<?php echo nova_link("index.php?func=newpost","newpost"); ?>">
						<table class="forum-jump" cellpadding="0" cellspacing="0">
							<tr>
								<td class="forum-jump-content" style="width:100%;">
...
<?php }elseif ($template_hook=='4'){ ?>
										<!-- show upload form -->
										<object id="uploadframe" standby="Loading..." data="<?php echo "$nova_domain"; ?>/uploads/upload.php?topicid=<?php echo "$new_topic"; ?>&attachtype=attachments&member=<?php echo "$uploader_id"; ?>&hash=<?php echo "$hash"; ?>" type="text/html" class="attachment-jump"></object>
									</div>
								</td></tr>
							</table>
