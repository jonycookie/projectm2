...
<?php }elseif ($can_read_topics=='0'){ ?>
					<?php echo $lang['online_stats_latest']; ?> <?php echo $lang['online_stats_restricted']; ?> (<?php echo "$topic_time"; ?>)
<?php }else{ ?>
					<?php echo $lang['online_stats_latest']; ?> <a class="forum-index-link-to-topic" href="<?php echo nova_link("index.php?page=findpost&post=$id","findpost/$id"); ?>"><?php echo "$title"; ?></a> (<?php echo "$topic_time"; ?>)
<?php } ?>
				</td>
			</tr>
			<tr>
...
<?php } elseif($template_hook=='3'){ ?>
					<!-- show online -->				
					<a class="forum-index-link-to-topic" href="<?php echo nova_link("index.php?page=list","online-now"); ?>"><span style="font-weight: normal;"><?php echo $lang['online_stats_recent']; ?></span></a>
<br />
