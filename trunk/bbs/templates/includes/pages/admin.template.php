...
<?php if ($can_change_site_settings=='1'){ ?>
				<tr>
					<td class="forum-jump-content forum-index-top" onmouseover="this.className='forum-jump-content-hover forum-index-top'" onmouseout="this.className='forum-jump-content forum-index-top'"><a class="forum-index-link-to-topic" href="<?php echo nova_link("index.php?page=admin", "admin"); ?>"><?php echo $lang['admin_link_home']; ?></a></td>
				</tr>
				<tr>
					<td class="forum-jump-content forum-index-top" onmouseover="this.className='forum-jump-content-hover forum-index-top'" onmouseout="this.className='forum-jump-content forum-index-top'"><a class="forum-index-link-to-topic" href="<?php echo nova_link("index.php?page=admin&act=settings", "admin/settings"); ?>"><?php echo $lang['admin_link_global']; ?></a></td>
				</tr>
...
<?php if ($can_change_site_settings=='1'){ ?>		
				<tr>
					<td class="forum-jump-content forum-index-top" onmouseover="this.className='forum-jump-content-hover forum-index-top'" onmouseout="this.className='forum-jump-content forum-index-top'"><a class="forum-index-link-to-topic" href="<?php echo "$nova_domain"; ?>/index.php?page=admin&act=<?php echo "$config_page"; ?>"><?php echo "$display_name"; ?></a></td>
				</tr>
<?php } ?>
