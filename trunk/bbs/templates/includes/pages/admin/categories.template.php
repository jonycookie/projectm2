...
<?php }elseif ($template_hook=="5"){ ?>
		...
		<form name="submit" method="post" action="<?php echo nova_link("index.php?page=admin&act=categories","admin/categories"); ?>">
...
<?php }elseif ($template_hook=="14"){ ?>
		<table class="forum-board-forum-head" cellpadding="0" cellspacing="0">
			...
			<tr><td class="forum-index-stats-sub"> </td></tr>
			<form name="settings" method="post" action="<?php echo nova_link("index.php?page=admin&act=categories","admin/categories"); ?>">
				<table class="forum-index" cellpadding="0" cellspacing="0">
...
<?php }elseif ($template_hook=="15"){ ?>
					<tr><td class="forum-index-stats-header forum-index-top">
						<div style="float: left; text-align: left;">
							<a href="<?php echo nova_link("index.php?page=admin&act=permissions&id=$id","admin/permissions/$id"); ?>" title="<?php echo $lang_admin['categories_permissions']; ?>"><?php echo "$name"; ?></a>&nbsp;&nbsp;
							<a href="<?php echo nova_link("index.php?page=admin&act=categories&func=edit&id=$id","admin/categories/edit/$id"); ?>"><img  src="<?php echo "$edit_icon_img"; ?>" alt="" /></a>
							<a href="<?php echo nova_link("index.php?page=admin&act=categories&func=delete&id=$id","admin/categories/delete/$id"); ?>"><img  src="<?php echo "$delete_icon_img"; ?>" alt="" /></a>	
						</div>
...
<?php }elseif ($template_hook=="18"){ ?>
						...
						<div style="width: 55%; float: left;">
							<a class="forum-index-link-to-topic" href="<?php echo nova_link("index.php?page=admin&act=permissions&id=$id","admin/permissions/$id"); ?>" title="Click to change this forums permissions"><?php echo "$name"; ?></a>
						</div>
...
<?php }elseif ($template_hook=="21"){ ?>
						<div style="width: 5%; float: left; text-align: center;"></div>
						<div style="width: 55%; float: left;">
							&nbsp;&nbsp;&nbsp;&nbsp;--> <a class="forum-index-link-to-topic" href="<?php echo nova_link("index.php?page=admin&act=permissions&id=$id","admin/permissions/$id"); ?>" title="<?php echo $lang_admin['categories_permissions']; ?>"><?php echo "$name"; ?></a>
						</div>
...
<?php }elseif ($template_hook=="24"){ ?>
						<div style="width: 100%; float: left; text-align: right;">
							<a class="submit-button img-add-forum" href="<?php echo nova_link("index.php?page=admin&act=categories&func=new&id=$parent_id","admin/categories/new/$parent_id"); ?>"><?php echo $lang['button_add_forum']; ?></a>
						</div>
						<br /><br />
<?php }elseif ($template_hook=="25"){ ?>
					</td></tr>
					<tr><td class="forum-index-stats-header forum-index-top" style="text-align: right;">
						<a class="submit-button img-add-forum" href="<?php echo nova_link("index.php?page=admin&act=categories&func=new","admin/categories/new/"); ?>"><?php echo $lang['button_add_root']; ?></a>
					</td></tr>
...
<?php }elseif ($template_hook=='warn'){ ?>
			...
			<table class="forum-board" cellpadding="0" cellspacing="0">
				...
				<td class="forum-index-stats-header forum-index-top" style="text-align: center;">
					<form name="warn" action="<?php echo "$nova_domain"; ?>/index.php?page=admin&act=categories&func=delete&id=<?php echo $_GET['id']; ?>" method="post">
						<input type="hidden" name="token_id" value="<?php echo $token_id; ?>" />
						<input type="hidden" name="<?php echo $token_name; ?>" value="<?php echo $token; ?>" />
