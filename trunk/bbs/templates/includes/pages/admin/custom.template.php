...
<?php }elseif ($template_hook=="4"){ ?>
		...
		<table class="forum-index" cellpadding="0" cellspacing="0">
			...
			<tr><td class="forum-jump-content forum-index-top forum-index-bottom">
				<form name="edit" method="post" action="<?php echo nova_link("index.php?page=admin&act=custom&func=edit","admin/custom/edit"); ?>">
...
<?php }elseif ($template_hook=="8"){ ?>
		...
		<table class="forum-index" cellpadding="0" cellspacing="0">
			<tr><td class="forum-index-stats-header forum-index-top"></td></tr>
			<tr><td class="forum-jump-content forum-index-top forum-index-bottom">
				<form name="edit" method="post" action="<?php echo nova_link("index.php?page=admin&act=custom&func=new","admin/custom/new"); ?>">
					<div style="width:30%; float: left;"><strong><?php echo $lang_admin['custom_field_name']; ?></strong><br /><br /></div>
...
<?php }elseif ($template_hook=="11"){ ?>
		...
		<form method="post" action="<?php echo nova_link("index.php?page=admin&act=custom","admin/custom"); ?>">
...
<?php }elseif ($template_hook=="12"){ ?>
					<div style="width:50%; float:left;"><a class="forum-index-link-to-topic" href="<?php echo nova_link("index.php?page=admin&act=custom&func=edit&id=$id","admin/custom/edit/$id"); ?>"><?php echo "$name"; ?></a></div>
					<div style="width:25%; text-align:right; float:left;">
					
						<a href="<?php echo nova_link("index.php?page=admin&act=custom&func=edit&id=$id","admin/custom/edit/$id"); ?>">
...
<?php }elseif ($template_hook=="16"){ ?>
				...
				<tr><td class="forum-index-stats-header forum-index-top" style="text-align: center;">
					<div style="width:50%; text-align:left; float:left;">
						<a class="submit-button img-add-forum" href="<?php echo nova_link("index.php?page=admin&act=custom&func=new","admin/custom/new"); ?>"><?php echo $lang['button_add_field']; ?></a>
					</div>
