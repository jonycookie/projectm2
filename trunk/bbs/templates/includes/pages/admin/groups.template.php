...
<?php }elseif ($template_hook=="4"){ ?>
		...
		<form name="settings" method="post" action="<?php echo nova_link("index.php?page=admin&act=groups","admin/groups"); ?>">
...
<?php if ($can_change_site_settings_form=="1"){ ?>
						<input type="checkbox" class="checkbox" name="can_change_site_settings" value="<?php echo "$can_change_site_settings_form"; ?>" checked <?php echo "$disabled"; ?> /><br /><br />
<?php }else{ ?>
...
<?php }elseif($template_hook=="7"){ ?>
				...
				<div style="width: 50%; float: left;">
					<a href="<?php echo nova_link("index.php?page=admin&act=groups&func=edit&id=$group_id","admin/groups/edit/$group_id"); ?>"><img  src="<?php echo "$edit_icon_img"; ?>" alt="<?php echo $lang_admin['custom_edit']; ?>" /></a>
<?php if ($group_id=="1"){}elseif ($group_id=="4"){}elseif ($group_id=="3"){}else{ ?>
					<form name="delete_one" method="post" action="<?php echo $nova_domain; ?>/index.php?page=admin&act=groups&func=delete">
...
<?php }elseif($template_hook=="8"){ ?>
			...
			<tr><td class="forum-index-stats-header forum-index-top" style="text-align: center;">
				<a class="submit-button img-group" href="<?php echo nova_link("index.php?page=admin&act=groups&func=new","admin/groups/new"); ?>"><?php echo $lang['button_group']; ?></a>
			</td></tr>
		</table>
		<table class="forum-index-forum-footer" cellpadding="0" cellspacing="0">
			<tr><td class="forum-index-forum-footer-contents"> </td></tr>
