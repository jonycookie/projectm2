...
<?php }elseif ($template_hook=="3"){ ?>
		...
		<form name="settings" method="post" action="<?php echo nova_link("index.php?page=admin&act=members","admin/members"); ?>">
...
<?php if ($banned=='0'){ ?>
					<form name="ban_member" method="post" action="<?php echo "$nova_domain"; ?>/index.php?page=admin&act=members&func=ban">
						<input type="hidden" name="token_id" value="<?php echo $token_id; ?>" />
						<input type="hidden" name="<?php echo $token_name; ?>" value="<?php echo $token; ?>" />
...
<?php }} ?>	
					<form name="unban_member" method="post" action="<?php echo "$nova_domain"; ?>/index.php?page=admin&act=members&func=delete">
						<input type="hidden" name="token_id" value="<?php echo $token_id; ?>" />
						<input type="hidden" name="<?php echo $token_name; ?>" value="<?php echo $token; ?>" />
						<input type="hidden" name="id" id="id" value="<?php echo "".$_GET['id'].""; ?>">
...
<?php }elseif ($template_hook=="10"){ ?>
		...
		<table class="forum-index" cellpadding="0" cellspacing="0">
			...
			<tr><td class="forum-index-stats-header forum-index-top"> </td></tr>
			<tr><td class="forum-jump-content forum-index-top forum-index-bottom">			
				<form name="name" method="get" action="<?php echo "$nova_domain"; ?>/index.php" class="asholder">
			...
			<tr><td class="forum-index-stats-header forum-index-top"> </td></tr>
			<tr><td class="forum-jump-content forum-index-top forum-index-bottom">
				<form name="email" method="get" action="<?php echo "$nova_domain"; ?>/index.php" class="asholder">
...
<script type="text/javascript">
	var options = {
		script:"<?php echo "$nova_domain"; ?>/scripts/php/autosuggest.php?json=true&admin=1&email=1&limit=20&",
		varname:"input",
		json:true,
		shownoresults:true,
		maxresults:1000,
	...
	var options_xml = {
		script: function (input) { return "<?php echo "$nova_domain"; ?>/scripts/php/autosuggest.php?input="+input+"&member="+document.getElementById('idemail').value; },
		varname:"input"
	};
	var as_xml = new bsn.AutoSuggest('testinput_xml', options_xml);
</script>		
