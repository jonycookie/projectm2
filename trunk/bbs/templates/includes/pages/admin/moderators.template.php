...
<?php }elseif ($template_hook=="1"){ ?>
		...
		<form name="settings" method="post" action="<?php echo nova_link("index.php?page=admin&act=moderators","admin/moderators"); ?>">
...
<?php }elseif ($template_hook=="2"){ ?>
		...
		<form name="name" method="post" action="<?php echo $nova_domain; ?>/index.php?page=admin&act=moderators&func=forum" class="asholder">
			<table class="forum-index" cellpadding="0" cellspacing="0">
				<tr><td class="forum-index-stats-header forum-index-top"> </td></tr>
				<tr><td class="forum-jump-content forum-index-top forum-index-bottom">
		...
		<script type="text/javascript">
			var options = {
				script:"<?php echo "$nova_domain"; ?>/scripts/php/autosuggest.php?json=true&admin=1&limit=20&",
				varname:"input",
				json:true,
				shownoresults:true,
				maxresults:1000,
			...
			var options_xml = {
				script: function (input) { return "<?php echo "$nova_domain"; ?>/scripts/php/autosuggest.php?input="+input+"&member="+document.getElementById('id').value; },
				varname:"input"
			};
...
<?php }elseif ($template_hook=="18"){ ?>
				...
				<div style="width: 50%; float: left; text-align: right; padding-top: 5px; padding-bottom: 5px;">
					<a class="submit-button img-add-user" href="<?php echo nova_link("index.php?page=admin&act=moderators&func=forum&forum=$id","admin/moderators/forum/$id"); ?>"><?php echo $lang['button_add_moderator']; ?></a>
				</div>
<?php }elseif ($template_hook=="4"){ ?>		
				...
				<div style="width: 55%; float: left;">
					<a href="<?php echo nova_link("index.php?page=admin&act=moderators&func=edit&forum=$id&id=$member_id","admin/moderators/edit/$id/$member_id"); ?>"><img  src="<?php echo "$edit_icon_img"; ?>" alt="" /></a>
					<a href="<?php echo nova_link("index.php?page=admin&act=moderators&func=delete&forum=$id&id=$member_id","admin/moderators/delete/$id/$member_id"); ?>" onclick="javascript:return confirm('<?php echo $lang['topic_remove']; ?>')"><img  src="<?php echo "$delete_icon_img"; ?>" alt="" /></a>
				</div>
		...
		<table class="forum-board" cellpadding="0" cellspacing="0">
			...
			<tr>
				<td class="forum-index-stats-header forum-index-top" style="text-align: center;">
					<form name="warn" action="<?php echo "$nova_domain"; ?>/index.php?page=admin&act=moderators&func=delete&id=<?php echo $_GET['id']; ?>&forum=<?php echo $_GET['forum']; ?>" method="post">
