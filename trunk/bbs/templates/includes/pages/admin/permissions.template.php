...
<?php }elseif ($template_hook=='2'){ ?>
		...
		<form name="permissions" method="post" action="<?php echo nova_link("index.php?page=admin&act=permissions","admin/permissions"); ?>">
