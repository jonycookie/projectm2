...
<?php }elseif($template_hook=="3"){ ?>
		...
		<form name="submit" id="submit" method="post" action="<?php echo nova_link("index.php?page=admin&act=subscriptions","admin/subscriptions"); ?>">
...
<?php }elseif($template_hook=="8"){ ?>
		...
		<form name="submit" id="submit" method="post" action="<?php echo nova_link("index.php?page=admin&act=subscriptions&func=edit","admin/subscriptions/edit"); ?>">
			<table class="forum-index" cellpadding="0" cellspacing="0">
...
<?php }elseif($template_hook=="14"){ ?>
				...
				<div style="width: 30%; float: left;">
					...
					<a href="<?php echo nova_link("index.php?page=admin&act=subscriptions&func=edit&id=$upgrade_id","admin/subscriptions/edit/$upgrade_id"); ?>">
						<img  src="<?php echo "$edit_icon_img"; ?>" alt="<?php echo $lang_admin['custom_edit']; ?>" />
					</a>
					
					<form method="post" action="<?php echo $nova_domain; ?>/index.php?page=admin&act=subscriptions">
...
<?php }elseif($template_hook=="15"){ ?>
			...
			<tr><td class="forum-index-stats-header forum-index-top" style="text-align: center;">
				<a class="submit-button img-money-add" href="<?php echo nova_link("index.php?page=admin&act=subscriptions&func=new","admin/subscriptions/new"); ?>"><?php echo $lang['button_add_subscription']; ?></a>
			</td></tr>
		</table>
		<table class="forum-index-forum-footer" cellpadding="0" cellspacing="0">
			<tr><td class="forum-index-forum-footer-contents"> </td></tr>
