...
<?php }elseif ($template_hook=='1'){ ?>
		...
		<form name="themes" method="post" enctype="multipart/form-data" action="<?php echo "$nova_domain"; ?>/index.php?page=admin&act=themes">
...
<?php }elseif($template_hook=='4'){ ?>
		...
		<table class="forum-board-forum-head" cellpadding="0" cellspacing="0">
			...
			<tr><td class="forum-index-stats-sub">
				<form method="post" action="<?php echo "$nova_domain"; ?>/index.php?page=admin&act=themes&alter=rss">
					<select name="order">
...
<?php }elseif($template_hook=='11'){ ?>	
								...
								<span style="text-align: right;">
									<a class="submit-button img-upload" href="<?php echo "$nova_domain"; ?>/index.php?page=admin&act=themes&func=remote&file=
...
<?php }elseif($template_hook=='13'){ ?>
		<div style="width:100%; text-align: right";>
			<a href="http://themes.novaboard.net"><strong><?php echo $lang_admin['themes_more']; ?></strong></a>
		</div>
		...
		<table class="forum-board" cellpadding="0" cellspacing="0">
			...
			<tr>
				<td class="forum-index-stats-header forum-index-top" style="text-align: center;">
					<form name="warn" action="<?php echo "$nova_domain"; ?>/index.php?page=admin&act=themes&func=<?php echo "$func"; ?>&file=<?php echo "$file"; ?>&theme=<?php echo "$themename"; ?>" method="post">
