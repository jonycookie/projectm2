...
<?php if ($can_view_forum=='1'){ ?>
					<a href="<?php echo nova_link("index.php?forum=$most_active", "forum/$forum_title-$most_active"); ?>"><?php echo "$forum_name"; ?></a>
<?php }else{ ?>
...
<?php } ?>
		...
		<table class="forum-jump" cellpadding="0" cellspacing="0">
			<tr><td class="forum-jump-content">
				...
				<a class="forum-index-link-to-topic" style="font-weight: normal;" href="<?php echo nova_link("index.php?page=search&area=topics&search=$id", "search/topics/$id"); ?>"><?php echo $lang['members_view_topics']; ?></a>
				&nbsp;&nbsp;|&nbsp;&nbsp;<a class="forum-index-link-to-topic" style="font-weight: normal;" href="<?php echo nova_link("index.php?page=search&area=posts&search=$id", "search/posts/$id"); ?>"><?php echo $lang['members_view_posts']; ?></a>
<?php if ($can_edit_members=='1'){ ?>
				&nbsp;&nbsp;|&nbsp;&nbsp;<a class="forum-index-link-to-topic" style="font-weight: normal;" href="<?php echo nova_link("index.php?page=admin&act=members&func=edit&id=$id", "admin/members/edit/$id"); ?>"><?php echo $lang['members_edit']; ?></a>
<?php } ?>
			</td></tr>
		</table>
