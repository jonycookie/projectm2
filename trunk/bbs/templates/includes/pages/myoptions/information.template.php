...
<?php }elseif ($template_hook=='1'){ ?>
			...
			<form method="post" action="<?php echo nova_link("index.php?page=myoptions&act=information","myoptions/information"); ?>">
...
<?php }elseif($template_hook=='5'){ ?>
					...
					<tr><td class="forum-index-stats-header forum-index-top"><?php echo $lang_user['information_admin_email_title']; ?></td></tr>
					<tr><td class="forum-jump-content forum-index-top forum-index-bottom">		
						<?php echo $lang_user['information_admin_email']; ?><br /><br />
						<div style="width: 30%; float: left;">
							<strong><?php echo $lang_user['information_admin_email_desc']; ?></strong>
						</div>
						<div style="width: 70%; float: left;">
