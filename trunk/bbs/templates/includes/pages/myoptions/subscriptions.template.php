...
<?php }elseif ($template_hook=='1'){ ?>
			...
			<form name="settings" method="post" action="<?php echo "$nova_domain"; ?>/index.php?page=myoptions&act=subscriptions&area=messages">
...
<?php }elseif ($template_hook=='2'){ ?>
					<div style="width: 70%; float: left;">
						<a href="<?php echo nova_link("index.php?forum=$subscribed_forum", "forum/$forum_title-$subscribed_forum"); ?>"><?php echo "$forum_title"; ?></a>
					</div>
					<div style="width: 30%; float: left;">
						<a href="<?php echo "$nova_domain"; ?>/index.php?page=myoptions&act=subscriptions&id=<?php echo "$row"; ?>" onclick="javascript:return confirm('<?php echo $lang['topic_remove']; ?>')"><img  src="<?php echo "$delete_icon_img"; ?>" alt="<?php echo $lang_admin['custom_delete']; ?>" /></a>
					</div>
...
<?php }elseif ($template_hook=='4'){ ?>	
					<div style="width: 70%; float: left;">
						<a href="<?php echo nova_link("index.php?topic=$subscribed_topic", "topic/$topic_title-$subscribed_topic"); ?>"><?php echo "$topic_title"; ?></a>
					</div>
					<div style="width: 30%; float: left;">
						<a href="<?php echo "$nova_domain"; ?>/index.php?page=myoptions&act=subscriptions&id=<?php echo "$row"; ?>" onclick="javascript:return confirm('<?php echo $lang['topic_remove']; ?>')"><img  src="<?php echo "$delete_icon_img"; ?>" alt="<?php echo $lang_admin['custom_delete']; ?>" /></a>
					</div>	
