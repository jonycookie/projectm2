...
function MoveZoneAD_Move() {
  if (this.Div.offsetLeft != (document.documentElement.scrollLeft + this.Left)) {
    var dx = (document.documentElement.scrollLeft + this.Left - this.Div.offsetLeft) * this.Delta;
    dx = (dx > 0 ? 1 :  - 1) * Math.ceil(Math.abs(dx));
    this.Div.style.left = this.Div.offsetLeft + dx;
  }

  if (this.Div.offsetTop != (document.documentElement.scrollTop + this.Top)) {
    var dy = (document.documentElement.scrollTop + this.Top - this.Div.offsetTop) * this.Delta;
