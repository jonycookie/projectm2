...
function PopZoneAD_Show() {
  ...
  if (this.PopType == 3 && this.ShowAD.ADType == 5) {
    window.showModelessDialog("" + this.ShowAD.ImgUrl + "","","scroll:0;status:0;help:0;toolbar=0;resizable:0;dialogTop:" + this.Top + "px;dialogLeft:" + this.Left + "px;dialogWidth:" + this.ZoneWidth + "px;dialogHeight:" + this.ZoneHeight + "px");
  } else {
    var OK = this.Struct();
...
function PopZoneAD_Window() {
  var strWin;
  strWin = "<html><head><meta http-equiv='content-type' content='text/html; charset=utf-8'><title>";
  strWin += this.ShowAD.ADName;
  strWin += "</title>";
