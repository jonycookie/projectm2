...
define('UC_DBNAME', 'center'); // UCenter 数据库名称
define('UC_DBCHARSET', 'utf8'); // UCenter 数据库字符集
define('UC_DBTABLEPRE', '`center`.uc_'); // UCenter 数据库表前缀
define('UC_DBCONNECT', '0'); // UCenter 数据库持久连接 0=关闭, 1=打开
define('UC_KEY', '24scaagfK6O7xcfd9bT8I1F2S1JcxezeraAbEdC0dajfqdH829F578DfoaS8p1zf'); // 与 UCenter 的通信密钥, 要与 UCenter 保持一致
define('UC_API', 'http://cms/center'); // UCenter 的 URL 地址, 在调用头像时依赖此常量
