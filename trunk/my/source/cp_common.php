...
/*
	...
	$Id: cp_common.php 12707 2009-07-15 09:32:37Z zhengqingpeng $
*/
...
if($op == 'logout') {
	...
	if(!in_array($_GET['idtype'], array('picid', 'blogid', 'albumid', 'tagid', 'tid', 'sid', 'uid', 'pid', 'eventid', 'comment')) || empty($_GET['id'])) {
