...
/*
	...
	$Id: cp_userapp.php 10607 2008-12-10 10:00:15Z liguode $
*/
...
if(submitcheck('ordersubmit')) {
	...
	foreach ($_POST['order'] as $key => $appid) {
		$appid = intval($appid);
		if($_SGLOBAL['my_userapp'][$appid]['displayorder'] != $displayorder) {
			updatetable('userapp', array('displayorder'=>$displayorder), array('appid'=>$appid, 'uid'=>$space['uid']));
		}
		$displayorder--;
	}
