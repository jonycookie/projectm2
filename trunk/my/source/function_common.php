...
/*
	...
	$Id: function_common.php 12766 2009-07-20 04:26:21Z liguode $
*/
...
function template($name) {
	...
	if($_SGLOBAL['mobile'] && $_SGLOBAL['mobile'] == md5($_SCONFIG['sitekey'])) {
	...
	switch ($friend) {
		...
		case 1://全好友可见
			if($space['uid'] == $touid) {
				...
				$_SGLOBAL[$var] = getfriendstatus($_SGLOBAL['supe_uid'], $touid)?true:false;
			}
			break;
		case 2://仅指定好友可见
			if($target_ids) {
