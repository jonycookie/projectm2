...
/*
	...
	$Id: space_blog.php 12768 2009-07-20 06:11:08Z liguode $
*/
...
if($id) {
	...
	$otherlist = $newlist = $blog['related'] = array();
	...
	//热点
	if(!$topic = topic_get($blog['topicid'])) {
		updatetable('blog', array('topicid'=>0), array('topicid'=>$blog['topicid']));
	}
