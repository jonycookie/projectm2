...
FCKConfig.ToolbarSets["Default"] = [
	...
	['FitWindow','PageBreak','insertFile']
] ;

FCKConfig.ToolbarSets["Basic"] = [
	['Source','-','Bold','Italic','-','OrderedList','UnorderedList','-','Link','Unlink','TextColor','BGColor']
] ;
FCKConfig.ToolbarSets["CBasic"] = [
...
FCKConfig.FontNames		= 'songti;xinsong;kaiti;heiti;Arial;CourierNew;Georgia;Tahoma;TimesNewRoman;Verdana;impact;WingDings' ;
FCKConfig.FontSizes		= '1/xxsmall;2/xsmall;3/normal;4/medium;5/large;6/xlarge;7/xxlarge' ;
...
FCKConfig.ImageUploadURL = "/very/admin.php?adminjob=edit&action=fckupload";
...
FCKConfig.FlashUploadAllowedExtensions	= ".(swf|fla|mp3|wma|wmv|avi|asx|asp|mov|qt|rm|rmvb|mid|ram)$" ;		// empty for all
