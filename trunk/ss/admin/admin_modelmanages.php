...
/*
	...
	$Id: admin_modelmanages.php 13411 2009-10-22 03:13:01Z zhaofei $
*/
...
if($listarr) {
	...
	if(!empty($listarr)) {
		foreach ($listarr as $listvalue) {
			...
			echo '<td align="center"><a href="'.S_URL.'/space.php?uid='.$_SGLOBAL['supe_uid'].'" target="_blank" >'.$listvalue['username'].'</a></td>';
