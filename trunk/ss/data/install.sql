...
DROP TABLE IF EXISTS supe_adminlog;
CREATE TABLE supe_adminlog (
...
CREATE TABLE supe_postitems (
  ...
  click_35 smallint(6) unsigned NOT NULL default '0',
  click_36 smallint(6) unsigned NOT NULL default '0',
