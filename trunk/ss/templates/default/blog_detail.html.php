	...
	<div class="box_r global_module bg_fff">
		...
		<div id="blog_article">
			...
			<div class="blog_op">
				...
				<a href="javascript:;" onclick="showajaxdiv('{S_URL}/batch.common.php?action=emailfriend&amp;uid=$blogdetail[uid]&amp;blogid=$blogdetail[blogid]', 400);">推荐给好友</a>&nbsp;|&nbsp;<a href="$_SC['uchurl']/cp.php?ac=common&op=report&idtype=blog&id=$blogdetail[blogid]" >举报</a>
			</div>
		</div>	
