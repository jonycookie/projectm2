...
<div class="column">
	...
	<!--{block name="spacenews" parameter="digest/1,2,3/order/i.viewnum DESC,i.dateline DESC/limit/0,6/cachetime/89877/subjectlen/34/subjectdot/0/cachename/hotnews2"}-->
	<div class="col2">
	...
	<div class="column">
		<div class="col1">
			<div class="global_module">
				...
				<ul class="global_tx_list1">
					<!--{block name="spacenews" parameter="type/$key/order/i.viewnum DESC/limit/0,12/cachetime/86900/subjectlen/40/subjectdot/0/showdetail/1/messagelen/100/messagedot/1/cachename/hotnews"}-->
