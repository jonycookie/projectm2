...
<div class="container" id="cpcontainer">
  ...
  <form name="cpform" method="post" action="<?=__SELF__?>?do=setting&operation=post" id="cpform" >
    ...
    <table class="tb tb2 ">
      ...
      <tr>
        <td width="314"><input name="name" value="<?=$iCMS->config['name']?>" type="text" class="txt" id="name"  /></td>
        <td width="418">网站名称</td>
        <td width="190">&lt;!--{$site.title}--&gt;</td>
      </tr>
      <tr class="nobg">
        <td colspan="2">网站 URL:</td>
        <td>&nbsp;</td>
      </tr>
      <tr>
        <td><input name="url" value="<?=$iCMS->config['url']?>" type="text" class="txt" id="url"  /></td>
        <td>网站 URL，必须以 http:// 开头，不要在网址最后加 / <br />
          如:http://www.idreamsoft.cn/iCMS</td>
        <td>&lt;!--{$site.url}--&gt;</td>
      </tr>
      <tr class="nobg">
        <td colspan="2">标题附加字:</td>
        <td>&nbsp;</td>
      </tr>
      <tr>
        <td><input name="seotitle" type="text" class="txt" id="seotitle" value="<?=$iCMS->config['seotitle']?>"  /></td>
        <td><span class="tdbg">网页标题通常是搜索引擎关注的重点，本附加字设置将出现在标题中论坛名称的后面，如果有多个关键字，建议用 &quot;|&quot;、&quot;,&quot;(不含引号) 等符号分隔</span></td>
        <td>&lt;!--{$site.seotitle}--&gt;</td>
      </tr>
      <tr class="nobg">
        <td colspan="2">网站关键字:</td>
        <td>&nbsp;</td>
      </tr>
      <tr>
        <td><input name="keywords" type="text" class="txt" id="keywords" value="<?=$iCMS->config['keywords']?>"  /></td>
        <td><span class="tdbg">更容易被搜索引擎找到用&quot;,&quot;号隔开</span></td>
        <td>&lt;!--{$site.keywords}--&gt;</td>
      </tr>
      <tr class="nobg">
        <td colspan="2">网站描述:</td>
        <td>&nbsp;</td>
      </tr>
      <tr>
        <td><input name="description" type="text" class="txt" id="description" value="<?=$iCMS->config['description']?>"  /></td>
        <td>将被搜索引擎用来说明您网站的主要内容</td>
        <td>&lt;!--{$site.description}--&gt;</td>
      </tr>
      <tr class="nobg">
        <td colspan="2">ICP备案号:</td>
        <td>&nbsp;</td>
      </tr>
      <tr>
        <td><input name="icp" type="text" class="txt" id="icp" value="<?=$iCMS->config['icp']?>"  /></td>
        <td>页面底部可以显示 ICP 备案信息，如果网站已备案，在此输入您的授权码，它将显示在页面底部，如果没有请留空</td>
        <td>&lt;!--{$site.icp}--&gt;</td>
      </tr>
      <tr class="nobg">
        <td colspan="2">站长信箱:</td>
        <td>&nbsp;</td>
      </tr>
      <tr>
        <td><input name="masteremail" type="text" class="txt" id="masteremail" value="<?=$iCMS->config['masteremail']?>"  /></td>
        <td>&nbsp;</td>
        <td>&lt;!--{$site.email}--&gt;</td>
      </tr>
      <tr class="nobg">
        <td colspan="2">默认模板:</td>
        <td>&nbsp;</td>
      </tr>
      <tr>
        <td><input name="template" type="text" class="txt" id="template" value="<?=$iCMS->config['template']?>" /></td>
        <td><img src="admin/images/selecttpl.gif" width="67" height="19" align="absmiddle" onclick="showDialog('<?=__SELF__?>?do=dialog&operation=template&hit=dir','template');"/></td>
        <td>&lt;!--{$site.tpl}--&gt;</td>
      </tr>
      <tr class="nobg">
        <td colspan="2">首页模板:</td>
        <td>&nbsp;</td>
      </tr>
      <tr>
        <td><input name="indexTPL" type="text" class="txt" id="indexTPL" value="<?=$iCMS->config['indexTPL']?>" /></td>
      ...
      <tbody id='html' style="display:none">
        ...
        <tr>
          <td><input name="htmlext" type="text" class="txt" id="htmlext" value="<?=$iCMS->config['htmlext']?>"  /></td>
          <td>推荐使用.html</td>
          <td>&nbsp;</td>
        </tr>
        <tr class="nobg">
        ...
        <tr>
          <td><input name="sortpagePre" type="text" class="txt" id="sortpagePre" value="<?=$iCMS->config['sortpagePre']?>"  /></td>
          <td>默认[list_]<br />C：栏目文件夹<br />CID：栏目id<br /></td>
          <td>&nbsp;</td>
        </tr>
        <tr class="nobg">
          <td>文章生成文件夹创建规则:</td>
        ...
        <tr>
          ...
          <td>C：栏目文件夹<br />Y：4位数年份，y：2位数年份<br />
      ...
      <tr class="nobg">
        <td colspan="3">缓存目录：</td>
      </tr>
      <tr>
        <td><input class="txt" name="cachedir" type="text" id="cachedir" value="<?=$iCMS->config['cachedir']?>" /></td>
        <td colspan="2">缓存目录</td>
      </tr>
      <tr class="nobg">
        <td colspan="3">缓存目录层级：</td>
      </tr>
      <tr>
        <td><input class="txt" name="cachelevel" type="text" id="cachelevel" value="<?=$iCMS->config['cachelevel']?>" /></td>
        <td colspan="2">缓存目录层级</td>
      </tr>
      <tr class="nobg">
        <td colspan="3">缓存时间：</td>
      </tr>
      <tr>
        <td><input class="txt" name="cachetime" type="text" id="cachetime" value="<?=$iCMS->config['cachetime']?>" /></td>
        <td colspan="2">缓存时间</td>
      </tr>
      <tr class="nobg">
        <td colspan="3">是否gzip压缩缓存数据：</td>
      </tr>
      <tr>
        <td><ul onmouseover="altStyle(this);">
      ...
      <tr class="nobg">
        <td colspan="3">匿名显示：</td>
      </tr>
      <tr>
        <td><input class="txt" name="anonymousname" type="text" id="anonymousname" value="<?=$iCMS->config['anonymousname']?>" /></td>
        <td colspan="2">匿名显示</td>
      </tr>
      <tr class="nobg">
        <td colspan="3">搜索每页显示多少条记录：</td>
      </tr>
      <tr>
        <td><input name="searchprepage" type="text" id="searchprepage" value="<?=$iCMS->config['searchprepage']?>" maxlength="6" class="txt"/></td>
      ...
      <tr class="nobg">
        <td colspan="3">服务器所在时区：</td>
      </tr>
      <tr>
        <td><select name="ServerTimeZone">
      ...
      <tr class="nobg">
        <td colspan="3">服务器时间校正（分钟）:</td>
      </tr>
      <tr>
        <td><input name="cvtime" type="text" id="cvtime" value="<?=$iCMS->config['cvtime']?>" maxlength="6" class="txt"/></td>
        <td colspan="2">此功能用于校正服务器操作系统时间设置错误的问题<br />
          当确认程序默认时区设置正确后，程序显示时间仍有错误，请使用此功能校正</td>
      </tr>
      <tr class="nobg">
        <td colspan="3">默认时间格式:</td>
      </tr>
      <tr>
        <td><input name="dateformat" type="text" id="dateformat" value="<?=$iCMS->config['dateformat']?>" class="txt"/></td>
      ...
      <tr class="nobg">
        <td colspan="3">自动提取内容摘要字数:</td>
      </tr>
      <tr>
        <td><input name="descLen" type="text" id="descLen" value="<?=$iCMS->config['descLen']?>" class="txt"></td>
        <td colspan="2">设置自动提取内容摘要字数</td>
      </tr>
      <tr class="nobg">
        <td colspan="3">是否检查文章标题重复:</td>
      </tr>
      <tr>
        <td><ul onmouseover="altStyle(this);">
      ...
      <tr class="nobg">
        <td colspan="3">是否分割系统生成自定链接:</td>
      </tr>
      <tr>
        <td><input name="CLsplit" type="text" id="CLsplit" value="<?=$iCMS->config['CLsplit']?>" class="txt"></td>
      ...
      <tr class="nobg">
        <td colspan="3">上传文件保存目录:</td>
      </tr>
      <tr>
        <td><input name="uploadfiledir" type="text" id="uploadfiledir" value="<?=$iCMS->config['uploadfiledir']?>" class="txt"></td>
        <td colspan="2">相对于程序根目录</td>
      </tr>
      <tr class="nobg">
        <td colspan="3">上传文件保存方式:</td>
      </tr>
      <tr>
        <td>
          <input name="savedir" type="text" id="savedir" value="<?=$iCMS->config['savedir']?>" size="50" class="txt"></td>
        <td colspan="2">为空全部存入同一目录<br />EXT：文件类型<br />Y：4位数年份，y：2位数年份<br />
          m：有前导零01-12，n：没前导零1-12<br />
          d：有前导零01-31，j：没前导零1-31</td>
      </tr>
      <tr class="nobg">
        <td colspan="3">允许上传文件类型:</td>
      </tr>
      <tr>
        <td><input name="fileext" type="text" id="fileext" value="<?=$iCMS->config['fileext']?>" size="50" class="txt"></td>
        <td colspan="2"></td>
      </tr>
      <tr class="nobg">
        <td colspan="3">是否生成缩略图:</td>
      </tr>
      <tr>
        <td><ul onmouseover="altStyle(this);">
      ...
      <tr class="nobg">
        <td colspan="3">缩略图宽度/高度:</td>
      </tr>
      <tr>
        <td>宽度： <input name="thumbwidth" type="text" value="<?=$iCMS->config['thumbwidth']?>" size=10 maxlength="3" class="txt"/> 像素 <br>
      ...
      <tr class="nobg">
        <td colspan="3">添加水印的图片大小控制:</td>
      </tr>
      <tr>
        <td>宽度： <input size="10" name="waterwidth" value="<?=$iCMS->config['waterwidth']?>" class="txt"/> 像素 <br />
      ...
      <tr class="nobg">
        <td colspan="3">水印图片文件:</td>
      </tr>
      <tr>
        <td><input name="waterimg" value="<?=$iCMS->config['waterimg']?>" class="txt"/></td>
        <td colspan="2">水印图片存放路径：include/watermark/<?=$iCMS->config['waterimg']?>，
          如果水印图片不存在，则使用文字水印</td>
      </tr>
      <tr class="nobg">
        <td colspan="3">水印文字:</td>
      </tr>
      <tr>
        <td><input name="watertext" value="<?=$iCMS->config['watertext']?>" size="40" class="txt"/></td>
        <td colspan="2">暂不支持中文</td>
      </tr>
      <tr class="nobg">
        <td colspan="3">水印文字字体大小:</td>
      </tr>
      <tr>
        <td><input name="waterfontsize" value="<?=$iCMS->config['waterfontsize']?>" size="10" class="txt"/></td>
        <td colspan="2"></td>
      </tr>
      <tr class="nobg">
        <td colspan="3">水印文字颜色:</td>
      </tr>
      <tr>
        <td><input name="watercolor" value="<?=$iCMS->config['watercolor']?>" size="10" maxlength="7" class="txt"/></td>
        <td colspan="2"></td>
      </tr>
      <tr class="nobg">
        <td colspan="3">水印透明度:</td>
      </tr>
      <tr>
        <td><input name="waterpct" value="<?=$iCMS->config['waterpct']?>" size="10" maxlength="3" class="txt"/></td>
        <td colspan="2"></td>
      </tr>
      ...
      <tr class="nobg">
        <td colspan="3">论坛程序类型:</td>
      </tr>
      <tr>
        <td><select name="bbs[type]" id="bbs[type]">
      <option value="PHPWind">PHPWind</option><option value="Discuz">Discuz!</option>
    </select></td>
        <td colspan="2"></td>
      </tr>
      <tr class="nobg">
        <td colspan="3">论坛网址:</td>
      </tr>
      <tr>
        <td><input name="bbs[url]" type="text" class="txt" id="bbs_url" value="<?=$iCMS->config['bbs']['url']?>" size="50"></td>
        <td colspan="2">后面不要加/</td>
      </tr>
      <tr class="nobg">
        <td colspan="3">论坛数据库服务器:</td>
      </tr>
      <tr>
        <td><input name="bbs[dbhost]" type="text" class="txt" id="bbs_dbhost" value="<?=$iCMS->config['bbs']['dbhost']?>" size="50"></td>
        <td colspan="2">本地请用localhost 远程请用IP 如：222.111.22.11</td>
      </tr>
      <tr class="nobg">
        <td colspan="3">论坛数据库用户名:</td>
      </tr>
      <tr>
        <td><input name="bbs[dbuser]" type="text" class="txt" id="bbs_dbuser" value="<?=$iCMS->config['bbs']['dbuser']?>" size="50"></td>
        <td colspan="2">如果论坛跟本程序同数据库可为空</td>
      </tr>
      <tr class="nobg">
        <td colspan="3">论坛数据库密码:</td>
      </tr>
      <tr>
        <td><input name="bbs[dbpw]" type="password" class="txt" id="bbs_dbpw" value="<?php //$iCMS->config['bbs']['dbpw'];?>" size="50"><br /> 如果不为空，每次修改请重新填写</td>
        <td colspan="2">如果论坛跟本程序同数据库可为空</td>
      </tr>
      <tr class="nobg">
        <td colspan="3">论坛数据库名:</td>
      </tr>
      <tr>
        <td><input name="bbs[dbname]" type="text" class="txt" id="bbs_dbname" value="<?=$iCMS->config['bbs']['dbname']?>" size="50"></td>
        <td colspan="2">论坛数据库名</td>
      </tr>
      <tr class="nobg">
        <td colspan="3">论坛数据库编码:</td>
      </tr>
      <tr>
        <td><input name="bbs[charset]" type="text" class="txt" id="bbs_charset" value="<?=$iCMS->config['bbs']['charset']?>" size="50"></td>
        <td colspan="2">为空则跟本程序同一编码 gbk utf8 gb2312</td>
      </tr>
      <tr class="nobg">
        <td colspan="3">论坛数据库前缀:</td>
      </tr>
      <tr>
        <td><input name="bbs[dbpre]" type="text" class="txt" id="bbs_dbpre" value="<?=$iCMS->config['bbs']['dbpre']?>" size="50"></td>
        <td colspan="2">论坛数据库前缀<br />PHPWind 常用pw_ &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp;Discuz! 常用cdb_</td>
      </tr>
      <tr class="nobg">
        <td colspan="3">论坛图片目录:</td>
      </tr>
      <tr>
        <td><input name="bbs[picpath]" type="text" class="txt" id="bbs_picpath" value="<?=$iCMS->config['bbs']['picpath']?>" size="50"></td>
        <td colspan="2">必须为论坛空间上的目录,如果设置绝对路径,目录分隔符请使用 / 不要使用 \ </td>
      </tr>
      <tr class="nobg">
        <td colspan="3">论坛附件目录:</td>
      </tr>
      <tr>
        <td><input name="bbs[attachdir]" type="text" class="txt" id="bbs_attachdir" value="<?=$iCMS->config['bbs']['attachdir']?>" size="50"></td>
        <td colspan="2">如果为远程附件地址，请填写附件网址</td>
      </tr>
      <tr class="nobg">
        <td colspan="3">是否开启静态目录部署功能:</td>
      </tr>
      <tr>
        <td><ul onmouseover="altStyle(this);">
        ...
        <td colspan="2">如果论坛未开启伪静态功能,请勿启用</td>
      </tr>
      <tbody id="pw" style="display:none;">
      <tr class="nobg">
        <td colspan="3">静态目录:</td>
      </tr>
      <tr>
        <td><input name="bbs[htmdir]" type="text" class="txt" id="bbs_htmdir" value="<?=$iCMS->config['bbs']['htmdir']?>" size="50"></td>
        <td colspan="2">保持与论坛设置一致</td>
      </tr>
      <tr class="nobg">
        <td colspan="3">静态目录扩展名设置:</td>
      </tr>
      <tr>
        <td><input name="bbs[htmext]" type="text" class="txt" id="bbs_htmext" value="<?=$iCMS->config['bbs']['htmext']?>" size="50"></td>
        <td colspan="2">保持与论坛设置一致</td>
      </tr>
      </tbody>
      <?php }?>
