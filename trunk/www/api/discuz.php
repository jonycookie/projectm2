...
/*
	...
	$Id: discuz.php 10735 2008-12-16 09:02:08Z zhengqingpeng $
*/
...
if(!empty($_SCONFIG['uc_dir']) && !strexssists($_SCONFIG['uc_dir'], ':/') && !strexists($_SCONFIG['uc_dir'], ':\\') && substr($_SCONFIG['uc_dir'], 0, 1) != '/') {
