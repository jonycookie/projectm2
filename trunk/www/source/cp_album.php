...
/*
	...
	$Id: cp_album.php 10941 2009-01-07 10:02:14Z zhengqingpeng $
*/
...
if($_GET['op'] == 'edit') {
	...
	if(submitcheck('editpicsubmit')) {
		...
		$url = empty($_POST['refer'])?"cp.php?ac=album&op=editpic&albumid=$albumid&start=$_POST[start]":$_POST['refer'];
