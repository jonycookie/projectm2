...
function king_ajax_about(){
	...
	$s.='<p>Copyright &copy; KingCMS.com</p>';
	$s.='<p>2004 - 2009</p>';
	$s.='<p><a href="http://www.kingcms.com/" target="_blank">http://www.kingcms.com</a></p>';
	$s.='</div>';
//	kc_ajax($king->lang->get('system/common/about').'..',$s,"<a class=\"k_ajax\" href=\"javascript:;\" rel=\"{CMD:'thank',IS:1,URL:'../system/login.php'}\">".$king->lang->get('system/login/team')."</a>",'',240,290);
	kc_ajax($king->lang->get('system/common/about').'..',$s,0,'',240,290);
} //!king_ajax_about
function king_ajax_thank(){
	global $king;
	$s="<div id=\"k_about\" title=\"KingCMS@Gmail.com\"><table class=\"k_table\" cellspacing=\"0\">
		<tr><th class=\"w100\">".$king->lang->get('system/login/operation')."</th><td>Alvin(911256)</td></tr>
		<tr><th>".$king->lang->get('system/login/dev')."</th><td>SinCS(13158118)</td></tr>
		<tr><th>".$king->lang->get('system/login/art')."</th><td>速水,苦树</td></tr>
		<tr><th>".$king->lang->get('system/login/editor')."</th><td>SinCS,Xavier Duan</td></tr>
		<tr><th>".$king->lang->get('system/login/trans')."</th><td>改良灰</td></tr>
		</table>
		<table class=\"k_table\" cellspacing=\"0\">
		<tr><th class=\"w100\">".$king->lang->get('system/login/other')."</th><td>gs444648,heii</td></tr>
		</table></div>";
	kc_ajax($king->lang->get('system/login/team'),$s,"<a href=\"javascript:;\" rel=\"{CMD:'about',URL:'../system/login.php',IS:1}\" class=\"k_ajax\">".$king->lang->get('system/common/about')."</a>",'',360,300);
}
 //退出登录
//king_ajax_logout
