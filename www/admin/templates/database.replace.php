...
<div class="container" id="cpcontainer">
  ...
  <form action="<?=__SELF__?>?do=database&operation=post" method="post">
    <table class="tb tb2 ">
      ...
      <tr>
        <td colspan="2" ><select name="field" id="field">
        ...
        <tr>
          <td><textarea  rows="6" onkeyup="textareasize(this)" name="pattern" id="pattern" cols="50" class="tarea"></textarea></td>
          <td>查找</td>
        </tr>
        <tr class="nobg">
          <td colspan="2">替换:</td>
        ...
        <tr>
          <td><textarea  rows="6" onkeyup="textareasize(this)" name="replacement" id="replacement" cols="50" class="tarea"></textarea></td>
          <td>替换</td>
        </tr>
        <tr class="nobg">
          <td colspan="2">附加条件:</td>
        </tr>
        <tr>
          <td><textarea  rows="6" onkeyup="textareasize(this)" name="where" id="where" cols="50" class="tarea"></textarea></td>
          <td>where (SQL语句)</td>
        </tr>
      <tr class="nobg">
