...
/*
	...
	$Id: js.php 10468 2008-12-04 07:36:39Z lifangming $
*/
...
END;
	...
	if(in_array($_GET['pagetype'], array('index', 'forumdisplay', 'viewthread')) && $side && $infosidestatus == 2) {
		...
		while ($value = $_SGLOBAL['db']->fetch_array($query)) {
			...
			$spacestr .= "<li><a href=\"{$siteurl}space.php?uid=$value[uid]\" target=\"_blank\"><img src=\"$avatar\"></a><p><a href=\"{$siteurl}space.php?uid=$value[uid]\" target=\"_blank\">$value[username]</a></p></li>";
		}
		$spacestr .= '</ul></div>';
