...
class Template {
	...
	var $debugging	   			= false;
	var $rewrite	   			= false;//2007-11-27 add by ¿ÝÄ¾ mod_rewrite
...
//		2007-11-27 ADD mod_rewrite url BY ¿ÝÄ¾
...
//	12:42 2008-8-10
	...
	function _run_modifier(){
		...
		if(in_array($modifier,array("include","system","exec","shell_exec","passthru","set_time_limit","ini_alter","dl","openlog","syslog","readlink","symlink","link","leak","popen","escapeshellcmd","apache_child_terminate","apache_get_modules","apache_get_version","apache_getenv","apache_note","apache_setenv","virtual","writefile","openfile","delfile","createdir"))){
			return false;
		}
//		foreach($arguments AS $arg){
//			if(strstr($arg,'include')){
//				return false;
//			}
//		}
